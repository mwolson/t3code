...
describe("ClaudeAdapterV2 background wake turns", () => {
      ...
      Effect.gen(function* () {
        ...
        yield* Queue.offer(
          ...
          claudeSdkFrame({
            type: "system",
            subtype: "task_started",
            task_id: "task-interrupt-timeout-subagent",
  ...
  it.effect("invalidates an offered continuation when the native query is replaced", () =>
    Effect.scoped(
      Effect.gen(function* () {
        const harness = yield* makeWakeHarness;
        const now = yield* DateTime.now;
        ...
        assert.isTrue(Option.isNone(guardedDispatch));
      ...
      Effect.gen(function* () {
        ...
        yield* Queue.offer(
          ...
          claudeSdkFrame({
            ...
            task_id: taskId,
            tool_use_id: toolUseId,
            description: "Alias registered after task start",
