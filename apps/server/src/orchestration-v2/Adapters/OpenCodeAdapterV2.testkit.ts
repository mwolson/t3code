...
export class OpenCode2ReplayTranscriptDecodeError extends Schema.TaggedError<OpenCode2ReplayTranscriptDecodeError>()(
...
export class OpenCode2ReplayMismatchError extends Schema.TaggedError<OpenCode2ReplayMismatchError>()(
...
export class OpenCode2ReplayIncompleteError extends Schema.TaggedError<OpenCode2ReplayIncompleteError>()(
  ...
  return {
    command: {
      list: async (input: unknown) => ({
        data: (await optionalCatalog("command.list", input, [])).data.data,
      }),
    },
    agent: {
      list: (input: unknown) =>
    ...
    session: {
      command: (input: unknown) => request("session.command", input),
      list: async (input: unknown) =>
        (await optionalCatalog("session.list", input, { data: [], cursor: {} })).data.data,
